...
<html lang="en">
  ...
  <body class="container">
    <h1>Exercício 12</h1>
    <form action="exer12rp.php" method="POST">
        <div class="row">
            <div class="col">
                <label for="base" class="form-label">Informe a base: </label>
                <input type="number" class="form-control" step="0.1" name="base" id="base">
            </div>
            <div class="col">
                <label for="expoente" class="form-label">Informe o expoente: </label>
                <input type="number" class="form-control" step="0.1" name="expoente" id="expoente">
            </div>
        </div>
        <div class="row mt-2">
            <div class="col">
